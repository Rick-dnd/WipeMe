...
function classifySmtpError(err) {
  ...
  if (msg.includes("535") || msg.includes("authentication") || msg.includes("invalid credentials") || msg.includes("username and password") || code === "eauth") {
...
export { classifySmtpError as a, classifyImapError as c, getTlsOptions as g };
