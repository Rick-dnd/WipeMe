...
const NOISE_WORDS = /* @__PURE__ */ new Set([
  "welcome",
  "willkommen",
  "hello",
  "hallo",
...
function isNewsletterEmail(subject, _from) {
  return newsletterPatterns.some((pattern) => pattern.test(subject));
}
function isAccountEmail(subject, from) {
...
function isResponseEmail(subject) {
  return responsePatterns.some((p) => p.test(subject));
}

export { isAccountEmail as a, isNewsletterEmail as b, extractServiceName as e, isResponseEmail as i };
